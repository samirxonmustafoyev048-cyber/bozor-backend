...
INSERT INTO "new_Order" ("address", "branchId", "courierId", "createdAt", "deliveryFee", "deliveryType", "discountAmount", "id", "orderNumber", "paid", "paidAt", "paymentMethod", "phone", "promoCode", "status", "totalPrice", "updatedAt", "userId") SELECT "address", "branchId", "courierId", "createdAt", "deliveryFee", "deliveryType", "discountAmount", "id", "orderNumber", "paid", "paidAt", "paymentMethod", "phone", "promoCode", "status", "totalPrice", "updatedAt", "userId" FROM "Order";
DROP TABLE "Order";
